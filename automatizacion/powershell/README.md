...
| `Preparar-MigracionAccesoRemotoSeguro.ps1` | Generar la migración incremental del acceso remoto y su SQL idempotente para revisión, sin modificar PostgreSQL. |
