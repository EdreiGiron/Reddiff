...
| RF-04     | `dispositivo`, `captura`, `version_config` | Carga de archivos y orquestación remota bajo demanda implementadas; conectores simulados validan el flujo seguro antes de habilitar adaptadores reales.         |
