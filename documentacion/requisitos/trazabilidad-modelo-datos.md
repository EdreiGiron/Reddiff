...
| RF-04     | `captura`, `version_config`                | Carga controlada de archivos implementada para dispositivos autorizados; captura remota SSH/NETCONF pendiente del almacenamiento cifrado de credenciales y la confianza explícita del host. |
...
Las pruebas de dominio, aplicación e integración verifican la normalización de cuentas y hosts, la protección de contraseñas, el rechazo CSRF, la sesión, los roles, los canales admitidos, la auditoría, las restricciones administrativas, el enmascaramiento exigido y la preservación de versiones sucesivas. Las pruebas del cliente verifican además que el técnico pueda consultar el inventario y operar el historial sin recibir controles administrativos.
