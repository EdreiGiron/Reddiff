...
| RF-04     | `dispositivo`, `captura`, `version_config` | Carga de archivos implementada; API y cliente administran secreto cifrado y confianza del host como requisito previo a conectores SSH/NETCONF de solo lectura. |
